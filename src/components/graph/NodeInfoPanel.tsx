                ...
                <>
                    ...
                    <div className="flex items-start justify-between p-4 border-b border-zinc-800/60">
                        <div className="flex-1 min-w-0 mr-3">
                            {/* File name */}
                            <h2 className="text-sm font-semibold text-zinc-100 truncate mb-1.5">
                                {node.name}
                            </h2>
                            {/* File path */}
                            <p className="text-[11px] text-zinc-600 font-mono truncate mb-2">
                                {node.path}
                            </p>
                            {/* Type badge */}
                            <span className={cn(
                    ...
                    <div className="flex-1 overflow-y-auto">
                        ...
                        <div className="p-4">
                            <div className={cn(
                                "rounded-xl p-4 border border-dashed border-zinc-700/60",
