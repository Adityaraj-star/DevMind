                ...
                {state.analyses.length > 0 && (
                        <section className="py-16 px-6" aria-labelledby="recent-heading">
                            <div className="max-w-4xl mx-auto text-center">
                                <h2 id="recent-heading" className="text-2xl font-bold text-[var(--zinc-100)] mb-3">
                                    Welcome back
                                </h2>
                                <p className="text-[var(--zinc-400)] text-sm mb-6">
                ...
                <footer className="border-t border-(--zinc-800)/60 py-8 px-6">
                    <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-1.5">
                            <span className="font-mono font-bold text-[var(--zinc-100)]">Dev</span>
                            <span className="font-mono font-bold text-violet-400">Mind</span>
                            <span className="font-mono text-xs text-[var(--zinc-600)] ml-1">v0.1</span>
                        </div>
                        <p className="text-[var(--zinc-600)] text-xs font-mono">
                            Built with React · TypeScript · Tailwind · D3
                        </p>
                        <p className="text-[var(--zinc-700)] text-xs">
                            Beta Build
                        </p>
                    </div>
                </footer>
